...
function loadNewsData(rawData, draw) {
  ...
  let removeWords = ["iot", "internet", "things", "--", "can", "will", "new", "hn", "data", "ask", "pdf", "10", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020",
    ...
    "whats", "chief", "fear", "people", "real", "change", "sending", "send", "trends", "trend", "show", "application", "solution", "solutions", "software", "engine", "guide", "technology", "big", "quot", "security", "http", "like", "thing", "rel", "nofollow", "get", "really", "use", "work", "time", "com", "system", "one", "company", "day", "think", "want", "know", "also", "way", "many", "say", "etc", "help", "even", "still", "let", "well","best", "got", "ext", "look", "see", "may", "using", "better", "much", "org", "high", "far", "run", "fix", "every", "last", "read", "able", "lot", "take", "used", "mean", "care", "per", "point", "set", "end", "try"
  ,"hand", "good", "never", "first", "part", "non", "put", "seems", "great", "pre", "exe", "pretty", "two", "name", "find", "around", "year", "found", "might",
  "file", "next", "hard", "sure", "idea", "working", "place", "write", "guy", "come", "feel", "start", "case", "code", "user", "email", "removephrase"];

  let removePhrases = ["big data", "bigdata", "internet of things", "iot", "cyber-physical system", "cyber physical system", "cps"];
