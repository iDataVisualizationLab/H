...
function drawWordStream(data) {
    ...
    cloudSvg.selectAll(".wordStreamGroup").remove();

    texts = cloudSvg.append("g").attr("class", "wordStreamGroup").attr("transform", `translate(${margin.axisx}, 0)`).selectAll('g').data(allWords).enter().append('g');
    texts
