...
!function (t, e) {
    ...
    "use strict";
    var s = 200, c = 8, o = 100, d = 1, f = 2, m = 3, p = 4;
    ...
    function h(t, h) {
        h = void 0 !== h ? h : null;
        var k = [0], x = [0], y = [0, 10], w = 100, A = 100, b = !0, D = "M-5.5,-5.5v10l6,5.5l6,-5.5v-10z", M = null,
            q = null, z = null, L = null, F = null, V = null, O = null,
            P = r.dispatch("onchange", "start", "end", "drag"), R = null, T = null, j = null,
            B = t === d || t === p ? -1 : 1, H = t === p || t === f ? "y" : "x", Q = t === p || t === f ? "x" : "y",
            U = t === d || t === m ? v : g, _ = t === d || t === m ? g : v, E = null;
        switch (t) {
            case d:
                E = a.axisTop;
                break;
        ...
        function I(a) {
            ...
            var r = R.selectAll(".slider").data([null]),
                l = r.enter().append("g").attr("class", "slider").attr("cursor", t === d || t === m ? "ew-resize" : "ns-resize").call(n.drag().on("start", function () {
                    ...
                    j = k[0] === y[0] && k[1] === y[0] ? 1 : k[0] === y[1] && k[1] === y[1] ? 0 : e.scan(k.map(function (t) {
            ...
            l.append("line").attr("class", "track").attr(H + "1", h.range()[0] - B * c).attr("stroke", "#bbb").attr("stroke-width", 6).attr("stroke-linecap", "round"), l.append("line").attr("class", "track-inset").attr(H + "1", h.range()[0] - B * c).attr("stroke", "#eee").attr("stroke-width", 4).attr("stroke-linecap", "round"), O && l.append("line").attr("class", "track-fill").attr(H + "1", 1 === k.length ? h.range()[0] - B * c : h(k[0])).attr("stroke", O).attr("stroke-width", 4).attr("stroke-linecap", "round"), l.append("line").attr("class", "track-overlay").attr(H + "1", h.range()[0] - B * c).attr("stroke", "transparent").attr("stroke-width", 40).attr("stroke-linecap", "round").merge(r.select(".track-overlay"));
            ...
            }), b && 1 === k.length && s.append("text").attr("font-size", 10).attr(Q, 27 * B).attr("dy", t === d ? "0em" : t === m ? ".71em" : ".32em").text(L(k[0])), a.select(".track").attr(H + "2", h.range()[1] + B * c), a.select(".track-inset").attr(H + "2", h.range()[1] + B * c), O && a.select(".track-fill").attr(H + "2", 1 === k.length ? h(k[0]) : h(k[1])), a.select(".track-overlay").attr(H + "2", h.range()[1] + B * c), a.select(".axis").call(E(h).tickFormat(L).ticks(F).tickValues(q)), R.select(".axis").select(".domain").remove(), a.select(".axis").attr("transform", _(7 * B)), a.selectAll(".axis text").attr("fill", "#aaa").attr(Q, 20 * B).attr("dy", t === d ? "0em" : t === m ? ".71em" : ".32em").attr("text-anchor", t === f ? "start" : t === p ? "end" : "middle"), a.selectAll(".axis line").attr("stroke", "#aaa"), a.selectAll(".parameter-value").attr("transform", function (t) {
                return U(h(t))
